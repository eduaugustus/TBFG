...
class MainMenu extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.tilemapTiledJSON("map_mainMenu", "../../game/The_Battle_Of_Gondria/game/assets/tilemap/mainMenuMap.json");
        this.load.image('logo', '../../game/The_Battle_Of_Gondria/game/assets/images/logo.png');
