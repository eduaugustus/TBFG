...
class Level_1_boss extends Phaser.Scene {
  ...
  preload() {
    this.load.audio('slime_boss', '../../game/The_Battle_Of_Gondria/game/assets/sounds/slime_boss_jump.wav');
    this.load.tilemapTiledJSON("map_1_boss", "../../game/The_Battle_Of_Gondria/game/assets/tilemap/map_fase_1_boss.json");
  }
